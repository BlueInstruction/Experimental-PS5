...
327:Downloading https://repo.maven.apache.org/maven2/com/google/guava/failureaccess/1.0.1/failureaccess-1.0.1.pom to /home/runner/.gradle/.tmp/gradle_download6864345640881027951bin
482:Downloading https://repo.maven.apache.org/maven2/com/google/guava/failureaccess/1.0.1/failureaccess-1.0.1.jar to /home/runner/.gradle/.tmp/gradle_download18386752241481654576bin
...
9058:> Task :app:compileDebugKotlin FAILED
9078:C/C++: TypeError: argument of type 'NoneType' is not iterable
9087:FAILURE: Build failed with an exception.
9091:> A failure occurred while executing org.jetbrains.kotlin.compilerRunner.GradleCompilerRunnerWithWorkers$GradleKotlinCompilerWorkAction
9102:	at org.gradle.internal.Try$Failure.ifSuccessfulOrElse(Try.java:293)
9130:	at org.gradle.internal.concurrent.ExecutorPolicy$CatchAndRecordFailures.onExecute(ExecutorPolicy.java:64)
9132:Caused by: org.gradle.workers.internal.DefaultWorkerExecutor$WorkExecutionException: A failure occurred while executing org.jetbrains.kotlin.compilerRunner.GradleCompilerRunnerWithWorkers$GradleKotlinCompilerWorkAction
9134:	at org.gradle.internal.work.DefaultAsyncWorkTracker.lambda$waitForItemsAndGatherFailures$2(DefaultAsyncWorkTracker.java:130)
9139:	at org.gradle.internal.work.DefaultAsyncWorkTracker.waitForItemsAndGatherFailures(DefaultAsyncWorkTracker.java:126)
9140:	at org.gradle.internal.work.DefaultAsyncWorkTracker.waitForItemsAndGatherFailures(DefaultAsyncWorkTracker.java:92)
9254:	at org.gradle.internal.concurrent.ExecutorPolicy$CatchAndRecordFailures.onExecute(ExecutorPolicy.java:64)
9256:Caused by: org.jetbrains.kotlin.gradle.tasks.CompilationErrorException: Compilation error. See log for more details
9289:BUILD FAILED in 3m 59s
```
...
8973:Resolve mutations for :app:configureCMakeDebug[arm64-v8a] (Thread[included builds,5,main]) started.
8974::app:configureCMakeDebug[arm64-v8a] (Thread[included builds,5,main]) started.
...
Transforming annotation-jvm-1.8.1.jar with BuildToolsApiClasspathEntrySnapshotTransform
...
Downloading https://repo.maven.apache.org/maven2/org/jetbrains/kotlin/kotlin-compose-compiler-plugin-embeddable/2.0.21/kotlin-compose-compiler-plugin-embeddable-2.0.21.pom to /home/runner/.gradle/.tmp/gradle_download9550262726321242686bin
Downloading https://repo.maven.apache.org/maven2/org/jetbrains/kotlin/kotlin-compose-compiler-plugin-embeddable/2.0.21/kotlin-compose-compiler-plugin-embeddable-2.0.21.jar to /home/runner/.gradle/.tmp/gradle_download12388210016516666221bin
...
e: file:///home/runner/work/PSX5/PSX5/app/src/main/java/com/px5/emulator/MainActivity.kt:116:21 Unresolved reference 'AppNavigation'.
